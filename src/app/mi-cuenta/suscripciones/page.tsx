              ...
              >
                <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                  ...
                  <div className="flex-1">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-3 text-sm text-gray-400 mt-4">
                      <div>
                  ...
                  <div className="flex flex-col gap-2 md:items-end">
                    {!subscription.invoiceIssued && subscription.status === "active" && (
                      <Link href={'/facturacion'} className="bg-green-600 hover:bg-green-700 text-white px-4 py-2 rounded-lg font-semibold transition text-sm">
                        Facturar
                      </Link>
                    )}
