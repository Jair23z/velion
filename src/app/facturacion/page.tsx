                ...
                {!generatedInvoice ? (
                    <form className='space-y-6'>
                        ...
                        <div className='bg-gray-900 border border-gray-800 rounded-lg p-6'>
                            <h2 className='text-2xl font-bold text-white mb-4'>Folio de Suscripción</h2>
                            ...
                            <div>
                                ...
                                <input
                                    className='w-full bg-gray-800 border-gray-700 border p-3 rounded-lg text-lg font-mono text-white focus:outline-none focus:border-green-500 focus:ring-1 focus:ring-green-500 transition'
                                    type="text"
                        ...
                        <div className='bg-gray-900 border border-gray-800 rounded-lg p-6'>
                            <h2 className='text-2xl font-bold text-white mb-4'>Datos Fiscales</h2>
                            
                            <div className='grid grid-cols-1 md:grid-cols-2 gap-4'>
                                <div>
                                    <label className='text-gray-400 text-sm font-medium'>RFC *</label>
                                    <input
                                        className='w-full bg-gray-800 border-gray-700 border p-2 rounded-lg text-sm mt-1 text-white focus:outline-none focus:border-green-600 focus:ring-2 focus:ring-green-600/50 uppercase'
                                        type="text"
                        ...
                        <div className='bg-gray-900 border border-gray-800 p-6 rounded-lg'>
                            <h2 className='text-xl font-bold text-white mb-4'>Domicilio Fiscal</h2>
                        ...
                        <div className='flex gap-4'>
                            <button
                                ...
                                className='flex-1 bg-gray-800 text-white p-3 rounded-lg font-bold hover:bg-gray-700 transition-colors duration-300 disabled:opacity-50 disabled:cursor-not-allowed border border-gray-700'
                            >
                            ...
                            <button
                                ...
                                className='flex-1 bg-green-600 text-white p-3 rounded-lg font-bold hover:bg-green-700 transition-colors duration-300 disabled:opacity-50 disabled:cursor-not-allowed'
                            >
                    ...
                    <div className='bg-green-900/20 border border-green-800 p-8 rounded-lg'>
